...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/kalmos/Swecha - Dev/Environments/lodge_complaint_env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/kalmos/Swecha - Dev/Environments/lodge_complaint_env/bin/deactivate.nu'
